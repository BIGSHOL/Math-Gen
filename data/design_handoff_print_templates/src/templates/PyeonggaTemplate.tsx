...
// 실제 통합 시: ProblemBody, KaTeX renderer, Choices 등은 BIGSHOL/Math-Gen 의
// MarkdownRenderer + PrintQuestionBlock 의 BodyBlock 로직을 재사용.
// 아래는 시그니처 형태만 보여줌.

interface ProblemBodyProps {
  problem: { question: string; choices?: string[] };
  fontSize?: number;
}

declare const ProblemBody: React.FC<ProblemBodyProps>;
