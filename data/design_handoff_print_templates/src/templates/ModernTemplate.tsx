...
export function ModernTemplate({
  ...
  const accent = options.accentColor || PAPER_COLORS.accentNavy;
      ...
      {isFirstPage && (
        <>
          ...
          >
            ...
            >
              {meta.title.includes("중간") ? "중간고사" : meta.title.includes("기말") ? "기말고사" : "평가"}
            </div>
          </div>
      ...
      >
        {problems.map((p, i) => {
          ...
          return (
            <div
              key={p.id}
              style={{ breakInside: "avoid", paddingBottom: 4 }}
            >
              <div
                style={{
                  display: "flex",
