...
const EXPLICIT_SUBJECTIVE_MARKERS = [
  /(?:\[\s*)?(단답형|서술형|주관식|논술형)\s*\d/,    // [서술형 3] / 서술형1 (괄호 유무 무관)
  ...
  // 답 작성 *명령형* — "...값을 구하시오/구하여라/쓰시오" 는 서술/단답 답안 작성
  // 지시 (= 주관식). 객관식은 "...구하면?" 처럼 *의문형*. 사용자 보고 (2026-06-02):
  // 서술형 크롭 "...구하시오." 문항이 객관식으로 오분류돼 "보기 누락" 오경고.
  /(구하시오|구하여라|구하라|쓰시오|적으시오|나타내시오|증명하시오|보이시오)/,
];
